...
\newfontfamily\footerfont{Trebuchet MS} % font for footer
% setup header & footer
\usepackage{fancyhdr}
\renewcommand{\headrule}{}% remove default header rule
\usepackage{etoolbox}
...
% reference with number and name
\newcommand*{\chref}[1]{\hyperref[{#1}]{\bfseries\MakeTextUppercase{Chapter~\ref{#1}}\hspace{1em}\nameref*{#1}}}
%%% pengaturan global

% format enumitem
\usepackage{enumitem}
\usepackage{calc}
\newcounter{numdesccount}
\renewcommand*\thenumdesccount{\arabic{numdesccount}.}
\newlist{numdesc}{description}{1}
\setlist[numdesc]{%
  before={\setcounter{numdesccount}{0}},%
  font=\normalfont\stepcounter{numdesccount}\thenumdesccount\hspace{4ex-\widthof{\thenumdesccount}},%
  style=nextline,           % Places the description text on the next line
  leftmargin=4ex,           % No extra left margin
}
% \newcounter{chdesccount}
% \renewcommand*\thechdesccount{\Roman{chdesccount}.}
% \newlist{chdesc}{description}{1}
% \setlist[chdesc]{%
%   before={\setcounter{chdesccount}{0}},%
%   font=\normalfont\stepcounter{chdesccount}\textbf{CHAPTER \Roman\thechdesccount}\hspace{4ex-\widthof{\thechdesccount}},%
%   style=nextline,           % Places the description text on the next line
%   leftmargin=4ex,           % No extra left margin
% }
% format judul
...
% Adjust float placement parameters
\setcounter{topnumber}{4}      % Max floats at top
...
\renewcommand{\textfraction}{0.05}   % Min text per page
