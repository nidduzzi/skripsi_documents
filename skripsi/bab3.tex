...
\begin{mini!}|s|
{\substack{W_b,b_b,W_t,b_t,\xi}}{\frac{1}{2}\Vert W_b\Vert_F^2 + \frac{1}{2}\Vert W_t\Vert_F^2 + \frac{c}{2}\sum_{i=1}^{l}\xi_i^2} {}{}
\addConstraint{y_i}{=(W_b f_i+b_b)^\top(W_t v_i+b_t)+\xi_i,\quad}{i=1,\ldots,l}
\end{mini!}
