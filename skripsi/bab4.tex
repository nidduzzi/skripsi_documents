...
\begin{figure}
    ...
    \end{adjustbox}
    % \includesvg[width=1.0\linewidth]{figures/computational_model.svg}
...
\begin{figure}[H]
    \centering
    \subfigure[]{
        \includegraphics[width=0.4\linewidth]{figures/Semiconductor-Fermi-Level-Band-Diagram-1.jpg}
        \label{surf-1}
